...
Branch `impl/v1-s16-yliluoma` now targets `main`.
Original validated join `578d677822d5daa8d4b63e7f2cb709c12fd608d0` contains S10 `47712a500c4079293a06fae4a07ae105a643af8f` and S12 `01df66826e532d8fb3b522a1564f1121c96f4d1f`.
...
S15 owns diffusion and its request correction. S13 reconstruction was outside the original base and remains unnecessary for palette mixing.
...
The shared prerequisite join fast-forwards to main `bfd1db91fcd86f0e8d4c0d2800b50c3bb9c35214`, preserving original S10/S12 ancestry.
S16 restacks without conflicts. Its exhaustive search, first ties, componentwise hue behavior, and fixtures remain unchanged.
All 230 native tests pass, including twelve Yliluoma tests. Locked benchmark-feature and Wasm-target checks, rustfmt, and diff checks pass with Rust 1.97.0.
No standalone timing workload or browser run occurs. No new frozen-reference amendment is introduced during this restack.
The exact S03, S11, and S14 amendments remain scheduled for S18, with the original identity and strict guards preserved.
