...
| [S03](#s03) | Define reference requests, results, errors, and mode inventory | [S01](#s01) | Blocked: two frozen-reference findings need Mia's decision; 14 focused tests pass | [#89](https://github.com/mia-cx/ditherette/pull/89) |
