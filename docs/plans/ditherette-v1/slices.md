...
| [S02](#s02) | Move builds and package ownership into their settled workspaces | [S01](#s01) | Baseline passes; approved pnpm 11.13.1 correction and fresh native-install validation active | [#88](https://github.com/mia-cx/ditherette/pull/88) |
