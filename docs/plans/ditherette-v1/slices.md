...
| [S19](#s19) | Ship the first scalar package call with bounded memory | [S02](#s02), [S06](#s06), [S18](#s18) | Merged 12bd2cef with optimized nearest restored; native, browser, guard, and CI checks pass | [#105](https://github.com/mia-cx/ditherette/pull/105), correction docs [#109](https://github.com/mia-cx/ditherette/pull/109) |
| [S20](#s20) | Benchmark complete public browser calls | [S19](#s19) | Blocked pending Mia approval of downstream validation fix `2ad564b4` (local only); validated and pushed at `9dcf0506`; PR review underway; PR109 folded in | [#107](https://github.com/mia-cx/ditherette/pull/107) |
