...
PRs #160 through #165 merged as `de9158cc`, `a80ce69c`, `39fc28c0`, `9e57b24d`, `85d5fb5a`, and `9f85ff4e`. PR #163 merged from exact-head-approved `d9baacec`; its twelve linked issues closed, while issue #149 remains open. PR #164 merged from exact-head-approved `7534bc9f`; issue #84 closed. PR #165 merged from exact-head-approved `f4c0bccb`; issues #80 and #81 closed. The merged PRs passed their recorded CI and exact-head Pullfrog review with no unresolved threads. The normal frozen check remains in force. Isolated guard-test amendment #167 previously merged as `e5359b83` with Mia's exception for that amendment only. Follow-up #169 merged as `3c1c16f0` from `bd9b45f8`, closing #168; its policy exception applies only to that one-line fixture-maintenance amendment.

The consolidated package stack through #165 is merged. Only website rollout #133 and legacy retirement #134 remain held. Issue #149, publication, and WebKit holds remain open. The original PR branches and discussions remain available. Supersession does not mean merged, reviewed, or newly validated.
...
PR #144 replaces runtime image hashing with verified source revisions and stage dependencies. Identity resize passes through internally.
...
PR #152 delivers exact diffusion preparation, matching, alpha classification and RGB-cache improvements. All 24 wider native selection cases pass.
Sparse nearest now covers resize and process locally under #151. The six-sample Chromium run preserves all 96 PNGs; 49 warm cases meet the JS target, 46 miss, and one is an identity no-op.
PR #154 delivers compact sparse gathers and direct standalone output. At 5%, 10%, and 25%, full nearest processing meets the cold and warm JS target in all three browsers; standalone resize still misses.
PR #155 delivers exact adaptive coordinate-row reuse. All 35 native gates pass, with 140 workers and 11,200 samples.
The 72-case adaptive browser sweep completes. Warm target passes are 23/24 Chromium, 24/24 Firefox, and 17/24 WebKit.
PR #158 extends nearest gathering to 50% dimensions while preserving larger separable/Yliluoma cache paths. Global widening was rejected after Bayer palette-edit regressions.
PR #159 hoists diffusion row addressing. All 35 native gates pass; WebKit 50% Floyd warm time improves from 609.5 to 589.5 ms, still behind JS at 383 ms.
...
| [S17](#s17) | Complete the five-method reference processor | [S05](#s05), [S10](#s10), [S11](#s11), [S13](#s13), [S14](#s14), [S15](#s15), [S16](#s16) | Merged e0101af7; 274 native tests pass; two threads resolved; exact-head approval | [#103](https://github.com/mia-cx/ditherette/pull/103) |
| [S18](#s18) | Freeze the complete reference and enforce immutability | [S17](#s17) | Merged 6ad907cd; 15 cold/warm mutation tests pass; exact-head approval; CodeQL exception recorded | [#104](https://github.com/mia-cx/ditherette/pull/104) (merged) |
| [S19](#s19) | Ship the first scalar package call with bounded memory | [S02](#s02), [S06](#s06), [S18](#s18) | Merged; optimized nearest restored | [#105](https://github.com/mia-cx/ditherette/pull/105), restoration [#109](https://github.com/mia-cx/ditherette/pull/109) folded via [#107](https://github.com/mia-cx/ditherette/pull/107) |
| [S20](#s20) | Benchmark complete public browser calls | [S19](#s19) | Merged `53efd548` | [#107](https://github.com/mia-cx/ditherette/pull/107) |
...
| [S24](#s24) | Implement packed-color direct quantization | [S19](#s19), [S20](#s20) | Merged `5a2c6244` | [#113](https://github.com/mia-cx/ditherette/pull/113) |
| [S25](#s25) | Complete weighted and perceptual matching | [S24](#s24) | Merged `9bcf3f7c`; cleanup verified | [#114](https://github.com/mia-cx/ditherette/pull/114) |
| [S26](#s26) | Implement scalar Bayer and random perturbation | [S25](#s25) | Merged `de9158cc`; normal guard, review, CI and three-browser conformance pass | [#160](https://github.com/mia-cx/ditherette/pull/160) |
| [S27](#s27) | Implement scalar blue-noise perturbation | [S26](#s26) | Merged `de9158cc`; normal guard, review, CI and three-browser conformance pass | [#160](https://github.com/mia-cx/ditherette/pull/160) |
...
| [S38](#s38) | Integrate the complete package behind the website flag | [S30](#s30) | Merged `9f85ff4e`; normal frozen check, all CI, and exact-head review pass; legacy default remains | [#165](https://github.com/mia-cx/ditherette/pull/165) |
| [S39](#s39) | Implement website cancellation and faithful fallback | [S38](#s38), [S34](#s34) | Merged `9f85ff4e`; three threads resolved, final guard/website/typecheck checks pass; fallback remains | [#165](https://github.com/mia-cx/ditherette/pull/165) |
