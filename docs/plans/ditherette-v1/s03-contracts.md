...
- [ ] Specify lifecycle and progress transitions with focused tests.
- [ ] Inventory every mode, export, and adapter; record validation and file the unmerged PR.

## Scope

This slice specifies requests and control behavior. S07 through S18 complete the processing references before S19 freezes them.
