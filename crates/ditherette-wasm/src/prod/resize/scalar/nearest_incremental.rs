//! Exact nearest production kernel promoted after the S19 native experiment.
//!
//! Coordinates retain the copied anchor formulas, replacing repeated division
//! with quotient/remainder additions. Arithmetic matches measured f9b51e45 unchanged.
