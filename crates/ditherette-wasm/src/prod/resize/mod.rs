...
//! packed RGBA8 at the boundary before they reach these kernels. The readable
//! `spec` implementations may stay generic; production resize is explicitly
//! RGBA8-only. Nearest additionally word-copies RGBA8 pixels internally; other
//! filters should still compute channels normally unless benchmarks prove a
//! safe packed-word strategy.
