...
use super::common::{linear_to_srgb_unit, srgb8_to_cielab, D65_XN, D65_YN, D65_ZN};

/// Converts encoded sRGB bytes to CIELAB relative to the existing D65 white.
pub fn rgb8_to_cielab([r, g, b]: [u8; 3]) -> [f32; 3] {
    srgb8_to_cielab(r, g, b)
}
...
/// Writes packed D65 CIELAB triples without interpreting or duplicating source alpha.
