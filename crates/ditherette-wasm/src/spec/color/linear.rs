...
use super::{linear_to_srgb_unit, srgb8_to_linear};

/// Decode RGB bytes with the sRGB transfer function into linear-light triplets.
pub fn rgb8_to_linear_rgb(rgb: [u8; 3]) -> [f32; 3] {
