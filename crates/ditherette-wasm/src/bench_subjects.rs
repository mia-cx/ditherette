...
use crate::{
    ...
    prod::resize::scalar::{
        ...
        bicubic_candidate::resize_bicubic_rgba8_into as resize_prod_bicubic_rgba8_into,
        bilinear::{
...
pub fn bench_subjects() -> Vec<BenchSubject> {
    let mut subjects = vec![
        ...
        resize_subject_with_oracle(
            "candidate:resize:bicubic:catmull-rom",
            "inherited candidate bicubic Catmull-Rom",
            "crates/ditherette-wasm/src/prod/resize/scalar/bicubic_candidate/mod.rs",
            resize_prod_bicubic_fixed_subject,
            Some("spec:resize:bicubic:catmull-rom"),
        ),
        resize_subject_with_oracle(
            "candidate:resize:bicubic:catmull-rom-scale-aware",
            "inherited candidate bicubic Catmull-Rom scale-aware",
            "crates/ditherette-wasm/src/prod/resize/scalar/bicubic_candidate/mod.rs",
        ...
        resize_subject_with_oracle(
            "candidate:resize:lanczos2:fixed",
            "inherited candidate Lanczos2 fixed support",
            "crates/ditherette-wasm/src/prod/resize/scalar/lanczos_candidate/mod.rs",
            resize_prod_lanczos2_fixed_subject,
            Some("spec:resize:lanczos2:fixed"),
        ),
        resize_subject_with_oracle(
            "candidate:resize:lanczos2:scale-aware",
            "inherited candidate Lanczos2 scale-aware",
            "crates/ditherette-wasm/src/prod/resize/scalar/lanczos_candidate/mod.rs",
        ...
        resize_subject_with_oracle(
            "candidate:resize:lanczos3:fixed",
            "inherited candidate Lanczos3 fixed support",
            "crates/ditherette-wasm/src/prod/resize/scalar/lanczos_candidate/mod.rs",
            resize_prod_lanczos3_fixed_subject,
            Some("spec:resize:lanczos3:fixed"),
        ),
        resize_subject_with_oracle(
            "candidate:resize:lanczos3:scale-aware",
            "inherited candidate Lanczos3 scale-aware",
            "crates/ditherette-wasm/src/prod/resize/scalar/lanczos_candidate/mod.rs",
