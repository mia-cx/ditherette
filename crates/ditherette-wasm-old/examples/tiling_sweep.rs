...
use ditherette_wasm::{
    ...
    resize::{
        ...
        bilinear::{
            resize_rgba_bilinear_scalar_into, resize_rgba_bilinear_with_row_band_tiling_into,
        },
...
fn run_target(
    ...
    match (target.kernel, mode) {
        ...
        .map_err(format_processing_error),
        (TilingKernel::Area, CaseMode::Scalar) => resize_rgba_area_scalar_into(
            source_rgba,
            source_dimensions,
            output_dimensions,
            output_rgba,
        ...
        .map_err(format_processing_error),
        (TilingKernel::Area, mode) => resize_rgba_area_with_row_band_tiling_into(
            source_rgba,
            source_dimensions,
            output_dimensions,
            output_rgba,
        ...
        .map_err(format_processing_error),
        (TilingKernel::Bilinear, CaseMode::Scalar) => resize_rgba_bilinear_scalar_into(
            source_rgba,
            source_dimensions,
            output_dimensions,
            output_rgba,
        ...
        .map_err(format_processing_error),
        (TilingKernel::Bilinear, mode) => resize_rgba_bilinear_with_row_band_tiling_into(
            source_rgba,
            source_dimensions,
            output_dimensions,
            output_rgba,
...
impl TilingTarget {
    fn parse(value: &str) -> Result<Self, String> {
        ...
        let kernel = match kernel {
            ...
            "bilinear" => TilingKernel::Bilinear,
