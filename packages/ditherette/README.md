...
An MIT-licensed browser ESM image processor. This private checkpoint supports scalar resize, palette quantization, Bayer/random/blue-noise perturbation, and error diffusion.
